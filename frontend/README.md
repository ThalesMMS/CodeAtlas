...
`DEEPWIKI_OPEN_LICENSE` and `../docs/deepwiki-experience.md`. The implementation is split into small typed modules under `src/knowledge-*.ts` and two scoped style sheets.
